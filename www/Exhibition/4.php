    ...
    <div id="wrap">
        ...
        <div id="sub_main">
            ...
            <section id="sub_contents" style="width: 71%;">
                <h3>영웅관<span>HOME > 전시 안내 ><b> 영웅관</b></span></h3>
                <div id="contents" class="mt-3">
                    <article id="sub_text">
                        <div>
                            ...
                            <br>
                            <p class="text-blue" style="font-size: 1.1em;margin-bottom:.4em;">영웅 중의 영웅 헤라클레스와 함께하는 12가지
                                과업</p>
                            <p>메두사를 물리친 페르세우스의 험난한 여정을 지나 미스터리 미궁 속에 갇힌 미노타우로스와 테세우스의 흥미진진한 대결!</p>
                            <p>호로메스의 일리아스, 그 대서사시 속으로 떠나는 트로이전쟁 체험!</p>
                            <p>지혜로운 오디세우스와 함께 동굴 속 키클롭스를 물리쳐주세요~</p>
                        </div>
                    </article>
                    <article>
                        <img src="http://www.greekmythology.co.kr/default/_template/image/default/02/exhibition_img04.jpg"
                            alt="">
                    </article>
                </div>
