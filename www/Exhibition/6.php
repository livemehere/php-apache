    ...
    <div id="wrap">
        ...
        <div id="sub_main">
            ...
            <section id="sub_contents" style="width: 71%;">
                <h3>사랑관<span>HOME > 전시 안내 ><b> 사랑관</b></span></h3>
                <div id="contents" class="mt-3">
                    <article id="sub_text">
                        <div>
                            ...
                            <br>
                            <p class="text-blue" style="font-size: 1.1em;margin-bottom:.4em;">신들이 살아 숨 쉴 것만 같은 환상의 정원. 그
                                안에서 펼쳐지는 사랑의 향연!</p>
                            <p>아폴론과 다프네의 슬픈 사랑이야기를 지나 메아리만 남은 에코와 샘물에 빠져 죽은 나르키소스 이야기.</p>
                            <p>명화로 살펴보는 피그말리온과 갈라테이아까지..</p>
                            <p>신화 속에 등장하는 아름다운 사랑을 느껴보세요. 그리고 위시트리에 간절한 소원을 적어주세요~</p>
                        </div>
                    </article>
                    <article>
                        <img src="http://www.greekmythology.co.kr/default/_template/image/default/02/exhibition_img06.jpg"
                            alt="">
                    </article>
                </div>
