    ...
    <div id="wrap">
        ...
        <div id="sub_main">
            ...
            <section id="sub_contents" style="width: 71%;">
                <h3>그리스의상 체험<span>HOME > 체험하기 ><b> 그리스의상 체험</b></span></h3>
                <div id="contents" class="mt-3">
                    <article id="sub_text">
                        <div>
                            ...
                            <br>
                            <p class="text-blue" style="font-size: 1.1em;margin-bottom:.4em;">고대 그리스 사람들은 어떤 옷을 입었을까?
                            </p>
                            <p>그리스 의상을 입고 그리스신화박물관을 관람하는 동안 나도 직접 그리스 신화 속 주인공이 되어볼까요?</p>
                        </div>
                    </article>
                    <article>
                        <img src="http://www.greekmythology.co.kr/default/_template/image/default/03/experience_img02.jpg"
                            alt="">
                    </article>
                </div>
