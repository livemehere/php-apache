    ...
    <div id="wrap">
        ...
        <div id="sub_main">
            ...
            <section id="sub_contents" style="width: 71%;">
                <h3>가면만들기 체험<span>HOME > 체험하기 ><b> 가면만들기 체험</b></span></h3>
                <div id="contents" class="mt-3">
                    <article id="sub_text">
                        <div>
                            ...
                            <br>
                            <p>그리스신화에 나오는 올림포스 12신의 가면을 직접 만들어 봐요~</p>
                        </div>
                    </article>
                    <article>
                        <img src="http://www.greekmythology.co.kr/default/_template/image/default/03/experience_img05.jpg"
                            alt="">
                    </article>
                </div>
