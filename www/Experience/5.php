    ...
    <div id="wrap">
        ...
        <div id="sub_main">
            ...
            <section id="sub_contents" style="width: 71%;">
                <h3>아르토이 체험<span>HOME > 체험하기 ><b> 아르토이 체험</b></span></h3>
                <div id="contents" class="mt-3">
                    <article id="sub_text">
                        <div>
                            ...
                            <br>
                            <p>나만의 아트토이를 직접 만들어보는 아트토이 체험은</p>
                            <p>그리스신화박물관에서 자체개발한 관람객대상 체험 교육프로그램 중 하나입니다.</p>
                            <p>재미와 창의력을 동시에 키우고, 가족과 연인에게는 서로를 그리거나 기념하는 추억을 남길 수 있습니다.</p>
                        </div>
                    </article>
                    <article>
                        <img src="http://www.greekmythology.co.kr/default/_template/image/default/03/experience_img06.jpg"
                            alt="">
                    </article>
                </div>
